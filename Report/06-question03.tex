...
Es gibt ein Limit von insgesamt 16 Monstern, da der vorgegebene Speicher für mehr nicht ausreicht.
In unserem Roomeditor können wir jetzt auch Monster platzieren. Beim aktivieren des "Spawn Mode" kann man absofort neue Monster platzieren.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{Bilder/06-question03_04.png}
    \caption{Spawn Mode On}
    \label{fig:enter-label}
\end{figure}